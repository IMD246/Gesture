...
class _HomeScreenState extends State<HomeScreen> {
  PermissionStatus _microphoneStatus = PermissionStatus.restricted;
  PermissionStatus _cameraStatus = PermissionStatus.restricted;
  PermissionStatus _photosStatus = PermissionStatus.restricted;
